package app.helium.heliumapp.ui.ibeacon
...
class ScanService {
    ...
    constructor(context: Context, deviceList: ArrayList<Any>) {
        this.deviceList = deviceList

        builder = ScanSettings.Builder()
        builder.setScanMode(ScanSettings.SCAN_MODE_LOW_LATENCY)
        Timber.d("Helium - set scan mode to low latency")
            ...
            if (result != null) {
                ...
                try {
                    if (scanRecord != null) {
                        ...
                        // TODO-FIXME-CLEANUP adapter.notifyDataSetChanged()
                    }
                } catch (e: SecurityException) {
                    Timber.e("@startScan SecurityException: " + e.message)
                }
