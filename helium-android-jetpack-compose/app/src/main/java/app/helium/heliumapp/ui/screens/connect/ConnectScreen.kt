package app.helium.heliumapp.ui.screens.connect
...
import app.helium.heliumapp.ui.ibeacon.ScanService
...
fun ConnectScreen(
    ...
    LaunchedEffect(key1 = "ConnectionScreenAppeared") {
        ...
        if (permissionState.allPermissionsGranted) {
            ...
            Timber.d("Helium - Permissions checks seemed to be passed")
        }
