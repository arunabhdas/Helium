...
import app.helium.heliumapp.data.gattble.CCCD_DESCRIPTOR_UUID
import app.helium.heliumapp.data.gattble.isIndicatable
import app.helium.heliumapp.data.gattble.isNotifiable
import app.helium.heliumapp.data.gattble.printGattTable
...
class HeliumBeaconBleReceiveManager @Inject constructor(
    private val bluetoothAdapter: BluetoothAdapter,
    private val context: Context
): HeliumBeaconReceiveManager {

    private val DEVICE_NAME = "Helium - iBeacon"
    ...
    override val data: MutableSharedFlow<Resource<HeliumBeaconResult>> = MutableSharedFlow()
    ...
    private val scanCallback = object: ScanCallback() {
        override fun onScanResult(callbackType: Int, result: ScanResult) {
            Timber.d("Helium - scanCallback - onScanResult")
            ...
            if (isScanning) {
                ...
                Timber.d("Helium - Connnect Gatt will be called")
    ...
    private val gattCallback = object: BluetoothGattCallback() {
        override fun onConnectionStateChange(
            ...
            Timber.d("Helium - onServicesDiscovered")
            if (status == BluetoothGatt.GATT_SUCCESS) {
                if (newState == BluetoothProfile.STATE_CONNECTED) {
                    ...
                    this@HeliumBeaconBleReceiveManager.gatt = gatt
                } else if (newState == BluetoothProfile.STATE_DISCONNECTED) {
                    coroutineScope.launch {
                        data.emit(
                            Resource.Success(
                            data = HeliumBeaconResult(
                                0f,
                                0f,
                                0f,
                                "Zone1",
        ...
        override fun onCharacteristicChanged(
            ...
            Timber.d("Helium - onCharacteristicChanged")
            with(characteristic) {
                when(uuid) {
                    UUID.fromString(BEACON_CHARACTERISTICS_UUID) -> {
                        ...
                        val tempHumidityResult = HeliumBeaconResult(
    ...
    override fun startReceiving() {
        coroutineScope.launch {
            Timber.d("Helium - Scanning for iBeacons")
            data.emit(
                Resource.Loading(
